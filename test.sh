...
try  23 'main(){ foo=3; bar=4*5; foo=foo+bar; foo; }'
try   2 'main(){ a1=10; a2=20; a2/a1; }'
try   5 'main(){ return 5; return 8; }'
try  10 'main(){ return1=7; return1+3; }'
try   5 'main(){ a=1; if(3>a) a=5; a; }'
try   1 'main(){ a=1; if(a>3) a=5; a; }'
try   5 'main(){ a=1; if(3>a) a=5; else a=7; a; }'
try   7 'main(){ a=1; if(a>3) a=5; else a=7; a; }'
try  16 'main(){ a=1; while(a<10) a=a*2; a; }'
try   1 'main(){ a=1; while(a>10) a=a*2; a; }'
try   8 'main(){ a=1; for(; a<5; ) a=a*2; a; }'
try  21 'main(){ b=1; for(a=63; a>10; a=a/3) b=b+1; a*b; }'
try 135 'main(){ for (a=5; a<100; a=a*3) {} a; }'
try   8 'main(){ a=1; b=2; if(a<2) {a=a+1; b=b+2;} a*b; }'
try   2 'main(){ 1+func0(); }'
